...
# Crop images and labels to 64x64 and 256x256
transform_train = transforms.CenterCrop((64, 64))
...
plt.savefig('figures/unet_64_loss.png')
...
plt.savefig('figures/unet_64_accuracy.png')
...
plt.tight_layout()
plt.savefig('figures/unet_64.png')