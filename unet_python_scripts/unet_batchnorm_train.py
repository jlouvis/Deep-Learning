...
import unet_batchnorm_architecture
from unet_batchnorm_architecture import Unet_batch
...
plt.savefig('figures/first_5_images_and_labels.png')
...
plt.savefig('figures/unet_batchnorm_loss.png')
...
plt.savefig('figures/unet_batchnorm_accuracy.png')
...
# the shapes of image, label and output are not matching...
...
plt.savefig('figures/unet_batchnorm_sample_prediction.png')